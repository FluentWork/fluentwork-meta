...
> **文档版本**：V1.2　**日期**：2026-09-10　**性质**：跨仓启动包归档与门禁对齐；进度入口改为完成度三档
...
先读这两份，不要用 9/6 的 Turn / Backend 盘点当完成度。Backend `67_` **V1.1** 把状态拆成已合并 / 已联调 / 已真机；截至该快照没有真机 E2E。

| 仓 | 报告 | `main` 锚点 |
|---|---|---|
| iOS | [`60_评审与复盘/66_iOS语音链路当前进度_2026-09-10.md`](./docs/60_评审与复盘/66_iOS语音链路当前进度_2026-09-10.md) | `fd17538` |
| Backend | [`60_评审与复盘/67_Backend语音链路当前进度_2026-09-10.md`](./docs/60_评审与复盘/67_Backend语音链路当前进度_2026-09-10.md) V1.1 | `2076fec` |
